...
from py_etiss_xvalid.entity.march.rv32 import RV32
from py_etiss_xvalid.exception.pipeline_exceptions import OutOfRegistersException

class RV32IMAC_zicsr(RV32):
