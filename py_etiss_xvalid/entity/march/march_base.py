...
class MArchBase(metaclass=SingletonABCMeta):
    ...
    def fetch_long_long_return_value(self, entry) -> Any:
        ...
        entries, if possible.  In case the  return value register has the
        same value as it had during  function prologue,  the return value
        should be considered to be inconclusive.
        """
        pass
    ...
    def fetch_long_double_return_value(self, entry) -> Any:
        ...
        the same  value as it had  during  function prologue, the return
        value should be considered to be inconclusive.
        """
        pass
